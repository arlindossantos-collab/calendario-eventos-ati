# Calendário de Eventos ATI — V2.2.0

> **Versão atual: 2.2.0** — controle de versão registrado em `VERSION` e `CHANGELOG.md`.
>
> A versão 2.2.0 revisa estruturalmente a navegação das abas da área administrativa, impede a renderização lado a lado dos painéis e registra todas as alterações no changelog.
